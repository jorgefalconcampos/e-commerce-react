  ...
  return (
    <div>
      <Row className="d-flex justify-content-center p-2 py-md-3 m-2 m-md-0 m-lg-0 mb-lg-3 border rounded">
        ...
        >
          <Row className="d-flex justify-content-center justify-content-sm-end align-items-start align-self-start">
            ...
            {/* <Col sm={} className="bg-info d-flex align-content-between flex-wrap justify-content-center ">
              <div className="p-1 ">
                <label htmlFor="qtty_item_1">Cantidad:</label>
                <Form.Select className="mt-1" id="qtty_item_1">
      ...
      {/* <Row className="d-flex justify-content-center p-3 m-2 mb-4 border rounded">
        <Col xs={12} md={3} lg={2} className="text-center py-2">
          <Image
            src="https://media.geeksforgeeks.org/wp-content/post-ads-banner/2021-12-29-16-30-50-CIP_Icon.png"
            className="rounded"
          ></Image>
        ...
        <Col xs={7} md={3} lg={3} className="d-flex ">
          <Row className="justify-content-xs-center justify-content-sm-end">
            <Col
              sm={8}
              className="d-flex align-content-between flex-wrap justify-content-center "
            >
              <div className="p-1 ">
                <label htmlFor="qtty_item_1">Cantidad:</label>
                <Form.Select className="mt-1" id="qtty_item_1">
